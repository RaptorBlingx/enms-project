 ...
 ******************************************************************************/
     ...
     * lost.
     */
credentialSecret: "enms-prod-secret-CHANGE-ME",
...
https://nodered.org/docs/security.html for details.
    ...
    //},
    // Uncomment the following section to enable HTTPS
    //https: {
    // key: require("fs").readFileSync('/home/ubuntu/.node-red/certs/privkey.pem'),
    //cert: require("fs").readFileSync('/home/ubuntu/.node-red/certs/cert.pem')
     //},
 ...
 ******************************************************************************/
   ...
   // httpNodeCors: {
     ...
     */
    httpStatic: '/home/ubuntu/.node-red/public', //single static source
    /**
