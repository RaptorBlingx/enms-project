...
-- This table holds the metadata for all devices. It must be created first.
...
-- This table stores historical print job data.
...
-- Part 4: Add All Primary Keys, Unique Constraints, and Foreign Keys
----------------------------------------------------------------------

-- Add constraints for the 'devices' table
...
-- Add constraints for the 'print_jobs' table
...
-- Add foreign keys from other tables to the 'devices' table
...
-- Part 5: Convert Tables to Hypertables (THIS MUST BE THE LAST STEP)
----------------------------------------------------------------------
-- This command tells TimescaleDB to manage these tables for time-series data.
