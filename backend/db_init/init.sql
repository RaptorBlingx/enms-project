...
-- === Convert Custom Sensor Hub Tables to Hypertables ===
SELECT create_hypertable('dht22_data', 'timestamp');
SELECT create_hypertable('max6675_temperature_data', 'timestamp');
SELECT create_hypertable('mpu6050_accelerometer_data', 'timestamp');
SELECT create_hypertable('mpu6050_gyroscope_data', 'timestamp');
SELECT create_hypertable('mpu6050_temperature_data', 'timestamp');
SELECT create_hypertable('printer_derived_status', 'timestamp');
SELECT create_hypertable('smartplug_data', 'timestamp');

-- === Convert Other Time-Series Tables to Hypertables (Verified) ===
SELECT create_hypertable('environment_data', 'timestamp');
SELECT create_hypertable('measurements', 'timestamp');
SELECT create_hypertable('monitor_readings', 'timestamp');
SELECT create_hypertable('monitor_state_analysis', 'timestamp');
SELECT create_hypertable('monitor_training_data', 'timestamp');
SELECT create_hypertable('power_predictions', 'timestamp');
